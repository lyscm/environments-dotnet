# [Required] Extensions
FROM --platform=$BUILDPLATFORM ghcr.io/lyscm/environments/dotnet/extensions as extensions
...
FROM ghcr.io/lyscm/environments/dotnet/base

ARG TARGETPLATFORM
ARG OWNER="lyscm"
ARG REPOSITORY_NAME="environments-dotnet"
